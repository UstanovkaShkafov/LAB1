...
int main()
{
    ...
    while (option) {
        ...
        case 12:
        {
            ...
            int choise = getcorrectnumber(1, 2);
            if (choise == 1) {
                ...
                if (network.graphs.size() != 0) {
                    ...
                    int x = getcorrectnumber(0, CS::max_idstation);
                    cout << "Input the exiting CS" << endl;
                    int y = getcorrectnumber(0, CS::max_idstation);
                    while (x == y) {
                        cout << "You can't disconnect same CS" << endl;
                        y = getcorrectnumber(0, CS::max_idstation);
                    }
